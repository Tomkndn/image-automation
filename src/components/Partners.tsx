      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-6 mb-16">
          {integrations.map((integration, i) => (
            <div
              key={i}
              className="group bg-slate-50 dark:bg-slate-800 rounded-2xl p-6 text-center hover:bg-white dark:hover:bg-slate-700 hover:shadow-lg transition-all duration-300 hover:-translate-y-1 border-2 border-transparent hover:border-indigo-100 dark:hover:border-indigo-700"
            >
        ...
        <div className="bg-gradient-to-br from-slate-50 to-indigo-50 dark:from-slate-800 dark:to-indigo-950 rounded-3xl p-12 text-center border border-indigo-100 dark:border-indigo-700">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <button className="border-2 border-slate-300 dark:border-slate-600 text-slate-700 dark:text-slate-200 px-8 py-4 rounded-full font-semibold hover:border-indigo-300 hover:text-indigo-600 dark:hover:border-indigo-700 dark:hover:text-indigo-400 transition-all duration-200">
              View Documentation
            </button>
          </div>
        </div>
